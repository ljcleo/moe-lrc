...
class SwitchTransformersSparseMLP(nn.Module):
    ...
    def __init__(self, config: SwitchTransformersConfig, layer_idx: int, expert_class: nn.Module = SwitchTransformersDenseActDense):
        super().__init__()
...
class SwitchTransformersLayerFF(nn.Module):
    ...
    def __init__(self, config: SwitchTransformersConfig, layer_idx: int, is_sparse=False):
        super().__init__()
        ...
        if not self.is_sparse:
            ...
            self.mlp = SwitchTransformersSparseMLP(config, layer_idx + config.num_layers if config.is_decoder else layer_idx)
...
class SwitchTransformersBlock(nn.Module):
    def __init__(self, config, has_relative_attention_bias=False, is_sparse=False, layer_idx: Optional[int] = None):
        ...
        self.layer.append(SwitchTransformersLayerFF(config, layer_idx=layer_idx, is_sparse=self.is_sparse))
